...
import static com.example.absensi.LoginActivity.guru;
...
import com.example.absensi.models.jadwal.User;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UpdateJadwalActivity.this, AdminJadwalActivity.class));
                finish();
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UpdateJadwalActivity.this, AdminHomeActivity.class));
                finish();
            }
        });
        ...
        int guru = intent.getIntExtra("siswa",0);
        int id = intent.getIntExtra("id",0);

        Call<ResponseJadwal> guruCall = ApiClient.getUserService().upjadwals(guru);
        guruCall.enqueue(new Callback<ResponseJadwal>() {
            @Override
            public void onResponse(Call<ResponseJadwal> call, Response<ResponseJadwal> response) {
                boolean status = response.body().isStatus();
                String pesan = response.body().getMessage();
                Toast.makeText(UpdateJadwalActivity.this, "status : " + status +"| pesan :" +pesan, Toast.LENGTH_SHORT).show();
                List<DataJadwal> dataGurus = response.body().getData();
                for (DataJadwal jad : dataGurus) {
                    String emapel, ekelas, ehari, ejam, enama;
                    enama = ""+jad.getUser().getName();
                    emapel = ""+jad.getMapel();
                    ekelas = ""+jad.getKelas();
                    ehari = ""+jad.getHari();
                    ejam =""+jad.getJam();
                    nama.setText(enama);
                    mapel.setText(emapel);
                    kelas.setText(ekelas);
                    hari.setText(ehari);
                    jam.setText(ejam);
            ...
            public void onFailure(Call<ResponseJadwal> call, Throwable t) {
                Toast.makeText(UpdateJadwalActivity.this,"failed"+t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ( ehari.isEmpty() || ekelas.isEmpty() || emapel.isEmpty() || ejam.isEmpty()){
                    ...
                    Toast.makeText(UpdateJadwalActivity.this, pesan, Toast.LENGTH_LONG).show();
                }else{
                                ...
                                update.enqueue(new Callback<ResponseJadwal>() {
                                    ...
                                    public void onResponse(Call<ResponseJadwal> call, Response<ResponseJadwal> response) {
                                        if (response.isSuccessful()) {
                                            ...
                                            Toast.makeText(UpdateJadwalActivity.this, pesan, Toast.LENGTH_LONG).show();
                                            startActivity(new Intent(UpdateJadwalActivity.this, UpdateJadwalActivity.class));
                                        }
                                    }
